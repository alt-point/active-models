...
export type Getter<M extends ActiveModel | unknown = ActiveModel, R = unknown> = (model: M, prop: string, receiver?: any ) => R

export type Setter<M extends ActiveModel | unknown = ActiveModel, V = unknown> = (model: M, prop: string, value: V, receiver?: any ) => boolean | void
